...
<img alt="first-class functions" src="./images/pooh-v2-01.jpg" width="960" />
...
<img src="./images/xkcd-random.png" width="1130" />
...
<img alt="side effects" src="./images/side-effects.jpg" width="840" />
...
- [Professor Frisby's Mostly Adequate Guide to Functional Programming](https://github.com/MostlyAdequate/mostly-adequate-guide)
  <small>([Brian Lonsdorf](https://twitter.com/drboolean))</small>
- [Functional Programming Design Patterns](https://fsharpforfunandprofit.com/fppatterns/)
  <small>([Scott Wlaschin](https://twitter.com/ScottWlaschin))</small>
- [Pure UI](https://rauchg.com/2015/pure-ui)
  <small>([Guillermo Rauch](https://twitter.com/rauchg))</small>
- [Hot Reloading with Time Travel](https://www.youtube.com/watch?v=xsSnOQynTHs)
  <small>([Dan Abramov](https://twitter.com/dan_abramov))</small>
